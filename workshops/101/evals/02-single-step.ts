...
const examples = [
  ...
  },
  {
    inputs: {
      messages:
        "My name is Aaron Mitchell. My number associated with my account is +1 (204) 452-6452. I am trying to find the invoice number for my most recent song purchase. Could you help me with it?",
    },
    outputs: { route: "invoice_information_subagent" },
  },
  {
    inputs: {
      messages:
        "Who recorded Wish You Were Here again? What other albums by them do you have?",
    },
    outputs: { route: "music_catalog_subagent" },
  },
  {
